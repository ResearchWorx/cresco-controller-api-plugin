...
public final class Authenticator {
 ...
 // An authentication token storage which stores <cookie, username>.
    private final Map<String, String> cookieStorage = new HashMap();
    ...
    private Authenticator() {
        ...
        serviceKeysStorage.put( "123", "username2" );


        //cookieStorage.put("12345","username1");
    }
    ...
    public boolean isCookieValid( String cookie ) 
    {
    	if(cookie != null)
    	{
    		...
    		*/
    		//return cookieStorage.containsKey( cookie );
